...
We can sometimes make better models by utilizing these correlations in the data using ARIMA models. Since the mean is not quite stationary, we can take the first difference we computed. 
...
acf2(inbound_summary_monthly_hrs_ts)
...
acf2(inbound_summary_monthly_pay_ts)
...
acf2(inbound_summary_weekly_hrs_ts)
...
acf2(inbound_summary_weekly_pay_ts)
