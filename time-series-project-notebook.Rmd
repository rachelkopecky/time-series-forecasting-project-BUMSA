...
### Data
The dataset contains details of the inbound and outbound operational data from multiple fulfillment centers in the local area over the period *2001-01-01* through *2017-12-31*. Important fields within the dataset include the date of work, warehouse location, department, task, hours spent and wage paid. 
