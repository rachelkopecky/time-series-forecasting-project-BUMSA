...
We can evaluate the ARIMA models by analyzing the residuals. From the residual analysis below, we can see that our ARIMA model for this series has relatively normally distributed, independent residuals.
