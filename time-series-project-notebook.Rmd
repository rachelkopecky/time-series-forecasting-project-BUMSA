...
# MSE
mean(ib_mon_hrs_cv_meanf^2, na.rm = T); mean(ib_mon_hrs_cv_rw^2, na.rm = T); mean(ib_mon_hrs_cv_rwd^2, na.rm = T); mean(ib_mon_hrs_cv_snaive^2, na.rm = T); mean(ib_mon_hrs_cv_hw^2, na.rm = T)

# MAE
mean(abs(ib_mon_hrs_cv_meanf), na.rm = T); mean(abs(ib_mon_hrs_cv_rw), na.rm = T); mean(abs(ib_mon_hrs_cv_rwd), na.rm = T); mean(abs(ib_mon_hrs_cv_snaive), na.rm = T); mean(abs(ib_mon_hrs_cv_hw), na.rm = T)

# Residuals
checkresiduals(inbound_summary_monthly_hrs_ts_ARIMA)
```
